...
import {
  type ComposerEditorDebugSnapshot,
  ...
  const onComposerCommandKey = (
    ...
    const submissionIntent =
      key === "Enter"
        ...
        : null;
    // The editor already decided this Enter submits, so honour it even when the
    // setting would otherwise have made Enter a newline.
    if (key === "Enter" && intent === "submit") {
      submitComposer(undefined, submissionIntent ?? "foreground");
      return true;
    }
    if (submissionIntent) {
