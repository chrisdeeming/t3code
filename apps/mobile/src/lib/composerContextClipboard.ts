...
const nativeClipboard = () =>
  requireNativeModule<{
    ...
    readContextClipboard: () => Promise<NativeContextClipboard>;
  }>("T3ComposerEditor");
...
export function readComposerContextClipboard(): Promise<NativeContextClipboard> {
  return nativeClipboard().readContextClipboard();
}
