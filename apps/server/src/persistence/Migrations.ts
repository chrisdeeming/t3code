...
import Migration0048 from "./Migrations/048_ProjectionThreadMessageContext.ts";
import Migration0049 from "./Migrations/049_SharedComposerDrafts.ts";
...
export const migrationEntries = [
  ...
  [48, "ProjectionThreadMessageContext", Migration0048],
  [49, "SharedComposerDrafts", Migration0049],
] as const;
